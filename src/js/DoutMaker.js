...
buyDonutMultiplier() {
  if(this._donutCount >= this._dontutMultiplierCost){
    this._donutMultiplierCount++;
    this._donutCount -= this._dontutMultiplierCost;
    this._dontutMultiplierCost = this._dontutMultiplierCost + (this._dontutMultiplierCost * 0.1);
  }
}
...
get donutMultiplierCost(){
  return this._dontutMultiplierCost;
}
}
